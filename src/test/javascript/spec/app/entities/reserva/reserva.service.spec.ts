...
import { IReserva, Reserva, EstadoReserva } from 'app/shared/model/reserva.model';
...
describe('Service Tests', () => {
  describe('Reserva Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Reserva(0, 'AAAAAAA', currentDate, currentDate, EstadoReserva.DISPONIBLE);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            fechaHoraInicio: currentDate.format(DATE_TIME_FORMAT),
            fechaHoraFin: currentDate.format(DATE_TIME_FORMAT)
          },
          elemDefault
        );
        service
