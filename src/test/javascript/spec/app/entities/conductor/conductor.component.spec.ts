...
import { ConductorComponent } from 'app/entities/conductor/conductor.component';
...
describe('Component Tests', () => {
  describe('Conductor Management Component', () => {
    let comp: ConductorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConductorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.conductors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
